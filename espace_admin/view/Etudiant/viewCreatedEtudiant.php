                        ...
                        <div class="cta-inner bg-faded text-center rounded">
                            <h2 class="section-heading mb-5">
                                ...
                                <?php if($verification==2){?>
                                    ...
                                    <span class="section-heading-lower">L'etudiant a bien été ajouté</span>
                                    <?php $ncin = $u->getNcin(); ?>
                                    <span class="section-heading-upper">Etudiant <a href='index.php?controller=etudiant&action=read&ID_etudiant=<?=$ncin ?>'> <?=$ncin?> </a> </span>
                                <?php }else	if($verification==1){?>
                                    <span class="section-heading-upper">échec</span>
                                    <span class="section-heading-lower">Etudiant existe déja !</span>	
                                <?php }else	{?>
