...
<body>
		...
		<div id="bande"class="here">
			...
			<div class="menu ">
				...
				<li><a href="#" id="Acceuil">Acceuil</a></li>
					...
					<li><a href="#" target="_blank">Conseils_medical</a></li>
				</ul>
			</div> 
		</div>		
	</nav>
	...
	<form class="inlinedisplay" name="creer_compte" method="post" action="#" onsubmit="return verifcreer(document.creer_compte.mot_de_passe)">
		...
		<legend>Créer un Compte</legend>
			<!---ncin--->
		<div>
			<label for="ID_etudiant"> Ncin<span id="etoile">*</span>:</label><br/>
			<input id="input" type="text" id="ID_etudiant" name="ID_etudiant" placeholder="Ncin" required autofocus />
		</div>
		<!---nom--->
		<div>
		...
		<div>
			...
			<!---Date de naissance--->
		<div>
			<label for="date_de_naissance">Date de naissance <span id="etoile">*</span>:</label><br/>
			<input id="input" type="date" id="date_de_naissance" name="date_de_naissance" placeholder="Date de naissance" required />
		</div>
			<!---Numero de telephone--->
		<div>
		...
		<div>
			...
			<datalist id="niveau">
				...
				<option value="2éme année mastére"></option>
			</datalist>
		</div>
			<!---Adresse e-mail--->
		<div>
	...
	<?php
	require_once("createdEtudiant.php");?>
	<?php if($verificationE==2){?>
		<div class="msgall">
		<span class="msg m1">SUCCES! l'etudiant crée</span></div>
	<?php }else	if($verificationE==1){?>
		<div class="msgall">
		<span class="msg">ECHEC! Etudiant existe!</span></div>	
