			...
			<div>
				<input class="button button1" type="submit" name="connection" value="Connexion"/>
				 <input  class="button button2" type="reset" name="reset" value="Effacer" /> 
					...
					<!---button créer compte--->
			<div>
			<button class="button button3" name="créercompte"><a href="creercompte.php">créez-compte etudiant</a></button> 
			<button class="button button3" name="créercompte"><a href="creercompteclient.php">créez-compte client               .         .</a></button> 
			</div>
		</form>
	</section>
	<style>
