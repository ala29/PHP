            ...
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <?php require_once("requettes.php");
                    ...
                    <div class="col mb-5">
                        ...
                        <img src="<?="../espace_etudiantentrepreneur/HTML/".$produit->photo?>" alt="img_produit<?= $produit->ID_projet ?>" class="img">                                                        <!-- Product details-->
                            ...
                            <div class="cardp-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btnn btn-outline-dark mt-auto" href="#">Acheter</a></div>
                            </div>
                        </div>
                    </div>
                   <?php } } ?> 
                   </section>
                   <?php if($_REQUEST['ID_etudiant'] == $_SESSION['ID_etud']){ ?>
                   <div class="classpr">
