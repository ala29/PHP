    ...
    <section>
		...
		<form class="inlinedisplay" name="connectezVous" method="POST" action="createdInscription.php">
			...
			<div>
				...
				<input id="input" type="text" name="nomprenometud" id="nomprenometud" value="<?=$_SESSION['nom_etudform']." ". $_SESSION['prenom_etudform']?>" readonly />
			</div>
			<div>
				<label for="id_guest"><span id="etoile"></span></label><br/>
				<input id="input" type="text" name="id_guest" id="id_guest" value="<?= $_SESSION['id_etudform'] ?>" readonly />
			</div>
