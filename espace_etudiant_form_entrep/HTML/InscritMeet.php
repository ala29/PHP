    ...
    <section>
		...
		<form class="inlinedisplay" name="connectezVous" method="POST" action="createdInscription.php">
			...
			<div>
				...
				<input id="input" type="hidden" name="id_etudiantF" id="id_etudiantF" value="<?=$_REQUEST['id_etudiantF']?>" readonly />
			</div>	
			<div>
				<label for="etudiantformateur">Nom Formateur :<span id="etoile"></span></label><br/>
				<input id="input" type="text" name="etudiantformateur" id="etudiantformateur" value="<?=$_REQUEST['etudiantformateur']?>" readonly />
			</div>
			<div>
			...
			<div>
				...
				<input id="input" type="text" name="nomprenometud" id="nomprenometud" value="<?=$_SESSION['nom_etudformentrep']." ". $_SESSION['prenom_etudformentrep']?>" readonly />
			</div>
			<div>
				<label for="id_guest"><span id="etoile"></span></label><br/>
				<input id="input" type="text" name="id_guest" id="id_guest" value="<?= $_SESSION['id_etudformentrep'] ?>" readonly />
			</div>
