            ...
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <?php require_once("requettes.php");
                    ...
                    <div class="col mb-5">
                        ...
                        <div class="imagee"><img src="<?="../../espace_etudiantentrepreneur/HTML/".$produit->photo?>" alt="img_produit<?= $produit->ID_projet ?>" class="img"></div>
                            <!-- <img class="cardp-img-top" src="https://dummyimage.com/450x300/dee2e6/6c757d.jpg" alt="..." /> -->
                            <!-- Product details-->
                   ...
                   <?php if($_REQUEST['ID_etudiant']==$_SESSION['id_etudformentrep']){ ?>
                   <div class="classpr">
